...
export const INGREDIENTS: IngredientDef[] = [
  ...
  { key: 'chia', name: 'Semillas de chía', emoji: '🌱', category: 'despensa', keywords: ['chia', 'chía', 'semillas de chia'] },
  { key: 'lino', name: 'Semillas de lino', emoji: '🌱', category: 'despensa', keywords: ['lino', 'linaza', 'semillas de lino'] },
